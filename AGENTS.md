...
- For any task that involves more than one concern (coding, testing, analysis, hardware, documentation, etc.), always use the `projectplanner` agent to decompose and coordinate the
  work
- The `projectplanner` agent lives at `~/.Codex/agents/projectplanner.md` and is always available
...
Add this as a new section in your existing AGENTS.md, right after the # Rules section. It tells Codex to always route complex tasks through projectplanner and reinforces its role
